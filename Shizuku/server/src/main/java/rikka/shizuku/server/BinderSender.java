...
public class BinderSender {
    ...
    private static final String PERMISSION_MANAGER = "com.sidhu.androidautoglm.permission.SHIZUKU_MANAGER";
    private static final String PERMISSION = "com.sidhu.androidautoglm.permission.SHIZUKU_API";
